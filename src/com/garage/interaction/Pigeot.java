...
public class Pigeot extends acceuil {
	...
	public Pigeot() {
		...
		//****************************************** CHOIX DE DU TYPE DE MOTEUR ******************************************************
			...
			do {
				sc.nextLine();
					...
					System.out.println("************************************************************\n");
					System.out.println("***  SECTION PIGEOT - A300B - TYPE DE MOTEUR DU GARAGE   ***\n");
					System.out.println("************************************************************\n");
					System.out.println("************************************************************\n");
					System.out.println("***         QUEL TYPE DE MOTEUR DESIREZ - VOUS           ***\n");
					System.out.println("***                                                      ***\n");
					System.out.println("***                 1 - ESSENCE - A300B                  ***\n");
					System.out.println("***                 2 - DIESEL - A300B                   ***\n");
					System.out.println("***                 3 - ELECTRIQUE - A300B               ***\n");
					System.out.println("***                 4 - HYBRIDE - A300B                  ***\n");
					System.out.println("***                                                      ***\n");
					...
					switch (choiceTypeMoteur)
					{
						case '1':
							...
							A300B_1.setMoteur(new MoteurEssence("150 Chevaux", 10256d));
							A300B_1.setPrix(23123.0);
							 garage.addVoiture(A300B_1);
							break;
						
						case '2':
							System.out.println("VOUS AVEZ CHOISIT UN MOTEUR DIESEL ");
							A300B_1.setMoteur(new MoteurDiesel("500 Hdi", 456987d));
							A300B_1.setPrix(25147.0);
							garage.addVoiture(A300B_1);
							break;
						
						case '3':
							System.out.println("VOUS AVEZ CHOISIT UN MOTEUR ELECTRIQUE ");
							A300B_1.setMoteur(new MoteurElectrique("100 KW", 1224d));
							A300B_1.setPrix(27457.0);
							garage.addVoiture(A300B_1);
							break;
		...
		//*************************************** CHOIX DES OPTIONS **************************************************************************
				do {
					sc.nextLine();
					System.out.println("************************************************************\n");
					System.out.println("***      SECTION PIGEOT - A300B - OPTION DU GARAGE       ***\n");
					System.out.println("************************************************************\n");
					System.out.println("************************************************************\n");
					...
					switch (choiceOption)
					{
						...
						case '4':
							...
							A300B_1.addOption(new Climatisation());
							garage.addVoiture(A300B_1);
							break;
						
						case '5':
							System.out.println("VOUS AVEZ CHOISIT L'OPTION SIEGE CHAUFFANT ");
							A300B_1.addOption(new SiegeChauffant());
							garage.addVoiture(A300B_1);
							break;
